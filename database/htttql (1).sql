...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 09, 2026 lúc 09:13 AM
...
INSERT INTO `khach_hang` (`id`, `ma_khach_hang`, `ten_khach_hang`, `so_dien_thoai`, `email`, `dia_chi`, `ngay_sinh`, `diem_tich_luy`, `ngay_tao`, `ghi_chu`) VALUES
(1, 'KH001', 'Khách lẻ', NULL, NULL, NULL, NULL, 0, '2026-06-09 13:47:49', NULL);
...
INSERT INTO `kho_hang` (`id`, `ma_vi_tri`, `ten_vi_tri`, `loai_vi_tri`) VALUES
(1, 'KHO_MAC_DINH', 'Kho Chính', NULL);
...
CREATE TABLE `khuyen_mai` (
  ...
  `loai_ap_dung` varchar(20) DEFAULT 'tat_ca',
  `gia_tri_ap_dung` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_vietnamese_ci;
...
INSERT INTO `khuyen_mai` (`id`, `ma_km`, `ten_chuong_trinh`, `ngay_bat_dau`, `ngay_ket_thuc`, `muc_giam`, `loai_ap_dung`, `gia_tri_ap_dung`) VALUES
(1, 'KM))!', 'Giảm giá chào hè', '2026-06-09 13:40:00', '2026-06-16 13:40:00', 10.00, 'tat_ca', '');
...
(3, 2, '87234688743', 'SP03', 'Mực sống', 'Kg', 70000.00, 80000.00, 5, NULL, 'assets/images/products/6a20cbd2a892d_1780534226.webp');
...
INSERT INTO `ton_kho` (`id`, `id_san_pham`, `id_kho_hang`, `so_luong`, `ngay_cap_nhat`) VALUES
(2, 3, 1, 30, '2026-06-04 08:21:25'),
(3, 2, 1, 30, '2026-06-04 08:21:31'),
(4, 1, 1, 30, '2026-06-04 08:21:37');
